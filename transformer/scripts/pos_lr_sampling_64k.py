...
plt.errorbar(ls_list, hyp_dict['64k'], se_dict['64k'], marker='o', label='sinusoid (64k)', color='blue', capsize=4)
plt.hlines(ref_dict['64k'][0], ls_list[0], ls_list[-1], label='reference', color='grey', linestyle='dashed')
plt.errorbar(ls_list, hyp_dict['pos_learned_64k'], se_dict['pos_learned_64k'], marker='o', label='learned', color='orange', capsize=4)
plt.errorbar(ls_list, hyp_dict['no_pos_64k'], se_dict['no_pos_64k'], marker='o', label='no_pos_64k', color='green', capsize=4)
plt.errorbar(ls_list, hyp_dict['rel_pos_64k'], se_dict['rel_pos_64k'], marker='o', label='rel_pos_64k', color='red', capsize=4)
...
plt.legend()
plt.savefig('img/pos_sampling_64k.png', dpi=400)
plt.clf()

plt.figure(figsize=(12,7))
plt.errorbar(ls_list, hyp_dict['64k'], std_dict['64k'], marker='o', label='sinusoid (64k)', color='blue', capsize=4)
plt.hlines(ref_dict['64k'][0], ls_list[0], ls_list[-1], label='reference', color='grey', linestyle='dashed')
plt.errorbar(ls_list, hyp_dict['pos_learned_64k'], std_dict['pos_learned_64k'], marker='o', label='learned', color='orange', capsize=4)
plt.errorbar(ls_list, hyp_dict['no_pos_64k'], std_dict['no_pos_64k'], marker='o', label='no_pos_64k', color='green', capsize=4)
plt.errorbar(ls_list, hyp_dict['rel_pos_64k'], std_dict['rel_pos_64k'], marker='o', label='rel_pos_64k', color='red', capsize=4)
plt.hlines(training_avg, ls_list[0], ls_list[-1], label='training set', color='grey', linestyle='dotted')
...
plt.xlabel('label smoothing alpha')
plt.legend()
plt.savefig('img/pos_sampling_64k_std.png', dpi=400)
plt.clf()
