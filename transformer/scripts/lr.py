...
plt.hlines(ref_dict['base'][0], ls_list[0], ls_list[-1], color='blue', label='16k (base) reference', linestyle='dashed')
plt.plot(ls_list, hyp_dict['4k'], '-o', label='4k', color='orange')
plt.hlines(ref_dict['4k'][0], ls_list[0], ls_list[-1], color='orange', label='4k reference', linestyle='dashed')
plt.plot(ls_list, hyp_dict['64k'], '-o', label='64k', color='green')
plt.hlines(ref_dict['64k'][0], ls_list[0], ls_list[-1], color='green', label='64k reference', linestyle='dashed')
plt.grid()
